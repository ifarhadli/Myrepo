...
(function(){
  ...
  function editableTarget(target){
    if(target.closest&&target.closest('.omni-bar,.omni-panel,.omni-dialog,.omni-section-tools,.omni-item-tools,.omni-collection-tools,.omni-item-toolbar,.omni-catalogue-add,.omni-image-action,.omni-collection-add'))return null;
  ...
  function makeMiniTools(collectionRich){
    ...
    tools.innerHTML=(collectionRich?'<button type="button" data-format="p">Paragraph</button><button type="button" data-format="h2">Heading</button><button type="button" data-format="list">List</button><button type="button" data-format="quote">Quote</button>':'')+'<button type="button" data-format="bold" aria-label="Bold"><b>B</b></button><button type="button" data-format="link">Link</button><button type="button" data-format="clear">Clear</button>'+(collectionRich?'<button type="button" data-format="done">Done</button>':'');
  ...
  function beginEdit(el){
    ...
    var selection=window.getSelection(),range=document.createRange();range.selectNodeContents(el);selection.removeAllRanges();selection.addRange(range);if(rich)makeMiniTools(collection);
  }
