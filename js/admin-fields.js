...
(function(){
  ...
  var help = {
    ...
    'Earlier':'Move to an earlier supported position in this section. Undo reverses the move.',
    'Later':'Move to a later supported position in this section. Undo reverses the move.',
